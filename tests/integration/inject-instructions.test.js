...
const fixturesDir = path.join(__dirname, '../fixtures/inject-instructions');
...
inputFiles.forEach(inputFile => {
  ...
  test(`inject-instructions processes ${testName}`, async () => {
    ...
    const resultMessages = injectInstructions(messages, resolved, fixturesDir);
